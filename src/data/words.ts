...
const SPECS: { id: string; label: string; blurb: string; rows: Row[] }[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      ['嫌い', 'きらい', ['disliked'], 'adjective'],
      ['上手', 'じょうず', ['skilful'], 'adjective'],
      ['下手', 'へた', ['unskilful'], 'adjective'],
  ...
  },
  {
    ...
    rows: [
      ...
      ['いただきます', 'いただきます', ['said before eating'], 'expression'],
      ['ごちそうさま', 'ごちそうさま', ['said after eating'], 'expression'],
      ['いってきます', 'いってきます', ['I am off'], 'expression'],
      ['ただいま', 'ただいま', ['I am home'], 'expression'],
